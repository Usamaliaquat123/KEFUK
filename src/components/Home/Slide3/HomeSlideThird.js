    ...
    <div className={HomeSlideThirdStyle.containerSlide} >
        ...
        <div className={HomeSlideThirdStyle.secondLayerContainer}>
           ...
           <div className='container-fluid'>
                <div className='row'>
                    <div className='col-md-7'><p className={HomeSlideThirdStyle.headingText}>Promoting 21st Century Quality Education in Kashmir & Pakistan for future generations.</p></div>    
                </div>   
            ...
            <div className={HomeSlideThirdStyle.circleLayer}>
                <div className={HomeSlideThirdStyle.imageLayer}>
                    <img src={bachiWatching} class="img-fluid" width={480} height={480}></img>
                </div>
            </div>
        </div>
