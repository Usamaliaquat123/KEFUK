...
const Donation = () => {
  ...
  return (
    <div style={{backgroundImage: `url(${backgroundImage})`, maxWidth: '100%', margin: 0, height: `100%`, backgroundSize: 'cover', backgroundSize: 'cover', backgroundRepeat: 'no-repeat',backgroundAttachment: 'fixed', backgroundPosition: 'center', minHeight: 650  }}>
        <div className='container-fluid'>
          <di className='row'>
            <div className='col-sm-6'>
                <div className={donation.cardContainer} style={{ background: `rgba(235, 93, 95, 0.8)`,  height: 'auto', width: 400, padding: 40, color: 'aliceblue', marginLeft: `12%` }}>
                    <div style={{ fontSize: 15, fontWeight: 'bold',  }}> Choose a donation amount</div>
                        ...
                        <p>Choose a donation frequency</p>
                            ...
                            <div className={donation.selectDonationFSelectorContainer}>
                              <div className={donation.donationFrequencyButtonOneTime}>
                                <span className={donation.donationOneTimeText}>One time</span>
                              </div>
                              <div className={donation.donationFrequencyButtonMonthly}><span className={donation.donationMonthlyText}>Monthly</span>
                              </div>
                            </div>
                    </div>
